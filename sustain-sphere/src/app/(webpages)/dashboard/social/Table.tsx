        ...
        <tbody>
          {tableData.map((rowData, index) => (
            <tr key={index} className={index % 2 === 0 ? 'bg-gray-50 text-center' : 'bg-white text-center'}>
              ...
              <td className="px-16 py-3 text-green-600">{rowData.col1}</td>
              <td className="px-16 py-3 text-green-600">{rowData.col2}</td>
              <td className="px-16 py-3 text-green-600">{rowData.col3}</td>
              <td className="px-16 py-3 text-green-600">{rowData.col4}</td>
              <td className="px-16 py-3 text-green-600">{rowData.col5}</td>
              <td className="px-16 py-3 text-green-600">{rowData.col6}</td>
            </tr>
          ))}
        </tbody>
      </table>
